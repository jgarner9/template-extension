...
let io = (r = 21) => crypto.getRandomValues(new Uint8Array(r)).reduce((e, t) => (t &= 63, t < 36 ? e += t.toString(36) : t < 62 ? e += (t - 26).toString(36).toUpperCase() : t > 62 ? e += "-" : e += "_", e), "");
...
function we(r, e, t = "log", o, i = "color: inherit") {
  ...
  o && n.push(o);
  const a = "Editor.js 2.30.0-rc.4", l = `line-height: 1em;
            color: #006FEA;
...
async function ao(r, e = () => {
  ...
  async function o(i, s, n) {
    try {
      await i.function(i.data), await s(at(i.data) ? {} : i.data);
    } catch {
      n(at(i.data) ? {} : i.data);
    }
  }
...
function je(r, e, t = void 0) {
  ...
  return function() {
    ...
    !a && t.leading === !1 && (a = d);
    const u = e - (d - a);
    return o = this, i = arguments, u <= 0 || u > e ? (n && (clearTimeout(n), n = null), a = d, s = r.apply(o, i), n || (o = i = null)) : !n && t.trailing !== !1 && (n = setTimeout(l, u)), s;
  };
}
function ho() {
  const r = {
...
class c {
  ...
  static findAllInputs(e) {
    return vt(e.querySelectorAll(c.allInputsSelector)).reduce((t, o) => c.isNativeInput(o) || c.containsOnlyInlineElements(o) ? [...t, o] : [...t, ...c.getDeepestBlockElements(o)], []);
  }
  /**
  ...
  static isElement(e) {
    return rt(e) ? !1 : e && e.nodeType && e.nodeType === Node.ELEMENT_NODE;
  }
  /**
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  static isFragment(e) {
    return rt(e) ? !1 : e && e.nodeType && e.nodeType === Node.DOCUMENT_FRAGMENT_NODE;
  }
  /**
...
const Ye = "redactor dom changed", Bt = "block changed", Tt = "fake cursor is about to be toggled", Ct = "fake cursor have been set", ke = "editor mobile layout toggled";
function Se(r, e) {
...
class R extends ye {
  ...
  constructor({
    ...
    super(), this.cachedInputs = [], this.toolRenderedElement = null, this.tunesInstances = /* @__PURE__ */ new Map(), this.defaultTunesInstances = /* @__PURE__ */ new Map(), this.unavailableTunesData = {}, this.inputIndex = 0, this.editorEventBus = null, this.handleFocus = () => {
      ...
      let h;
      d || u ? h = !0 : h = !(l.length > 0 && l.every((b) => {
   ...
   */
  updateCurrentInput() {
    this.currentInput = c.isNativeInput(document.activeElement) || !m.anchorNode ? document.activeElement : m.anchorNode;
  }
  /**
   * Allows to say Editor that Block was changed. Used to manually trigger Editor's 'onChange' callback
   * Can be useful for block changes invisible for editor core.
  ...
  async getActiveToolboxEntry() {
    ...
    return e.find((i) => Object.entries(i.data).some(([s, n]) => t[s] && mo(t[s], n)));
  }
  /**
  ...
  async exportDataAsString() {
    ...
    return yo(e, this.tool.conversionConfig);
  }
  /**
  ...
  watchBlockMutations() {
    ...
    this.redactorDomChangedCallback = (t) => {
      const { mutations: o } = t;
      o.some((s) => wo(s, this.toolRenderedElement)) && this.didMutated(o);
    }, (e = this.editorEventBus) == null || e.on(Ye, this.redactorDomChangedCallback);
  }
  /**
  ...
  unwatchBlockMutations() {
    var e;
    (e = this.editorEventBus) == null || e.off(Ye, this.redactorDomChangedCallback);
  }
  /**
      ...
      t.exports = function() {
        ...
        return { show: function(l) {
          if (l.message) {
            ...
            a.appendChild(d), d.classList.add(n);
          }
        } };
      }();
    }, function(t, o, i) {
      ...
      function z(v, g) {
        ...
        if (g.singleton) {
          ...
          v.sourceMap && typeof URL == "function" && typeof URL.createObjectURL == "function" && typeof URL.revokeObjectURL == "function" && typeof Blob == "function" && typeof btoa == "function" ? (w = function(B) {
            ...
            return B.attrs.type === void 0 && (B.attrs.type = "text/css"), B.attrs.rel = "stylesheet", Q(j, B.attrs), L(B, j), j;
          }(g), E = (function(B, j, pe) {
            var te = pe.css, _e = pe.sourceMap, eo = j.convertToAbsoluteUrls === void 0 && _e;
            (j.convertToAbsoluteUrls || eo) && (te = b(te)), _e && (te += `
/*# sourceMappingURL=data:application/json;base64,` + btoa(unescape(encodeURIComponent(JSON.stringify(_e)))) + " */");
            var to = new Blob([te], { type: "text/css" }), nt = B.href;
            B.href = URL.createObjectURL(to), nt && URL.revokeObjectURL(nt);
          }).bind(null, w, g), I = function() {
            A(w), w.href && URL.revokeObjectURL(w.href);
          }) : (w = S(g), E = (function(B, j) {
            var pe = j.css, te = j.media;
...
`);
      ...
      t.exports = function(i) {
        ...
        return i.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(l, d) {
          var u, h = d.trim().replace(/^"(.*)"$/, function(f, b) {
            return b;
      ...
      var s, n, a, l, d, u, h, f, b;
      t.exports = (s = "cdx-notifies", n = "cdx-notify", a = "cdx-notify__cross", l = "cdx-notify__button--confirm", d = "cdx-notify__button--cancel", u = "cdx-notify__input", h = "cdx-notify__button", f = "cdx-notify__btns-wrapper", { alert: b = function(p) {
        ...
        var k = b(p), L = document.createElement("div"), A = document.createElement("button"), S = document.createElement("button"), Q = k.querySelector("." + a), z = p.cancelHandler, U = p.okHandler;
        return L.classList.add(f), A.innerHTML = p.okText || "Confirm", S.innerHTML = p.cancelText || "Cancel", A.classList.add(h), S.classList.add(h), A.classList.add(l), S.classList.add(d), z && typeof z == "function" && (S.addEventListener("click", z), Q.addEventListener("click", z)), U && typeof U == "function" && A.addEventListener("click", U), A.addEventListener("click", k.remove.bind(k)), S.addEventListener("click", k.remove.bind(k)), L.appendChild(A), L.appendChild(S), k.appendChild(L), k;
      }, prompt: function(p) {
        var k = b(p), L = document.createElement("div"), A = document.createElement("button"), S = document.createElement("input"), Q = k.querySelector("." + a), z = p.cancelHandler, U = p.okHandler;
        return L.classList.add(f), A.innerHTML = p.okText || "Ok", A.classList.add(h), A.classList.add(l), S.classList.add(u), p.placeholder && S.setAttribute("placeholder", p.placeholder), p.default && (S.value = p.default), p.inputType && (S.type = p.inputType), z && typeof z == "function" && Q.addEventListener("click", z), U && typeof U == "function" && A.addEventListener("click", function() {
          U(S.value);
    ...
    t.prototype.clean = function(h) {
      ...
      if (p)
        do {
          ...
          var A = !!f.parentNode, S = i(f) && i(p) && A, Q = p.nodeName.toLowerCase(), z = l(this.config, Q, p), U = k && L;
...
var No = It.exports;
const Ro = /* @__PURE__ */ Me(No);
function Ve(r, e) {
  return r.map((t) => {
    const o = M(e) ? e(t.tool) : e;
    return K(o) || (t.data = qe(t.data, o)), t;
  });
}
function q(r, e = {}) {
  const t = {
  ...
  return new Ro(t).clean(r);
}
function qe(r, e) {
  return Array.isArray(r) ? Do(r, e) : D(r) ? Po(r, e) : G(r) ? Fo(r, e) : r;
}
function Do(r, e) {
  return r.map((t) => qe(t, e));
}
function Po(r, e) {
  const t = {};
  for (const o in r) {
...
var Yo = Mt.exports;
const Ko = /* @__PURE__ */ Me(Yo);
let H = null;
function Ze() {
  H || (H = new Ko());
}
function Xo(r, e, t) {
  Ze(), H == null || H.show(r, e, t);
}
function Ke(r = !1) {
  Ze(), H == null || H.hide(r);
}
function ve(r, e, t) {
  Ze(), H == null || H.onHover(r, e, t);
}
function Vo() {
...
function Lt(r, e) {
  ...
  return Object.entries(r).forEach(([o, i]) => {
    if (D(i)) {
      const s = e ? `${e}.${o}` : o;
      Object.values(i).every((a) => G(a)) ? t[o] = s : t[o] = Lt(i, s);
      return;
    }
    t[o] = i;
  }), t;
...
const At = class ge {
  ...
  leafNodesAndReturnIndex(e) {
    if (this.items.length === 0)
      return this.cursor;
    let t = this.cursor;
    return t === -1 ? t = e === ge.directions.RIGHT ? -1 : 0 : this.items[t].classList.remove(this.focusedCssClass), e === ge.directions.RIGHT ? t = (t + 1) % this.items.length : t = (this.items.length + t - 1) % this.items.length, c.canSetCaret(this.items[t]) && Ce(() => m.setCursor(this.items[t]), 50)(), this.items[t].classList.add(this.focusedCssClass), t;
  }
};
At.directions = {
  RIGHT: "right",
...
const Jo = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M9 12L9 7.1C9 7.04477 9.04477 7 9.1 7H10.4C11.5 7 14 7.1 14 9.5C14 9.5 14 12 11 12M9 12V16.8C9 16.9105 9.08954 17 9.2 17H12.5C14 17 15 16 15 14.5C15 11.7046 11 12 11 12M9 12H11"/></svg>', _t = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7 10L11.8586 14.8586C11.9367 14.9367 12.0633 14.9367 12.1414 14.8586L17 10"/></svg>', Qo = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M14.5 17.5L9.64142 12.6414C9.56331 12.5633 9.56331 12.4367 9.64142 12.3586L14.5 7.5"/></svg>', ei = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M9.58284 17.5L14.4414 12.6414C14.5195 12.5633 14.5195 12.4367 14.4414 12.3586L9.58284 7.5"/></svg>', ti = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7 15L11.8586 10.1414C11.9367 10.0633 12.0633 10.0633 12.1414 10.1414L17 15"/></svg>', oi = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 8L12 12M12 12L16 16M12 12L16 8M12 12L8 16"/></svg>', ii = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><circle cx="12" cy="12" r="4" stroke="currentColor" stroke-width="2"/></svg>', si = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M13.34 10C12.4223 12.7337 11 17 11 17"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M14.21 7H14.2"/></svg>', ut = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M7.69998 12.6L7.67896 12.62C6.53993 13.7048 6.52012 15.5155 7.63516 16.625V16.625C8.72293 17.7073 10.4799 17.7102 11.5712 16.6314L13.0263 15.193C14.0703 14.1609 14.2141 12.525 13.3662 11.3266L13.22 11.12"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M16.22 11.12L16.3564 10.9805C17.2895 10.0265 17.3478 8.5207 16.4914 7.49733V7.49733C15.5691 6.39509 13.9269 6.25143 12.8271 7.17675L11.3901 8.38588C10.0935 9.47674 9.95706 11.4241 11.0888 12.6852L11.12 12.72"/></svg>', ni = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M9.40999 7.29999H9.4"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M14.6 7.29999H14.59"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M9.30999 12H9.3"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M14.6 12H14.59"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M9.40999 16.7H9.4"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2.6" d="M14.6 16.7H14.59"/></svg>', ri = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M12 7V12M12 17V12M17 12H12M12 12H7"/></svg>', ai = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><circle cx="10.5" cy="10.5" r="5.5" stroke="currentColor" stroke-width="2"/><line x1="15.4142" x2="19" y1="15" y2="18.5858" stroke="currentColor" stroke-linecap="round" stroke-width="2"/></svg>', li = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M15.7795 11.5C15.7795 11.5 16.053 11.1962 16.5497 10.6722C17.4442 9.72856 17.4701 8.2475 16.5781 7.30145V7.30145C15.6482 6.31522 14.0873 6.29227 13.1288 7.25073L11.8796 8.49999"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8.24517 12.3883C8.24517 12.3883 7.97171 12.6922 7.47504 13.2161C6.58051 14.1598 6.55467 15.6408 7.44666 16.5869V16.5869C8.37653 17.5731 9.93744 17.5961 10.8959 16.6376L12.1452 15.3883"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M17.7802 15.1032L16.597 14.9422C16.0109 14.8624 15.4841 15.3059 15.4627 15.8969L15.4199 17.0818"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M6.39064 9.03238L7.58432 9.06668C8.17551 9.08366 8.6522 8.58665 8.61056 7.99669L8.5271 6.81397"/><line x1="12.1142" x2="11.7" y1="12.2" y2="11.7858" stroke="currentColor" stroke-linecap="round" stroke-width="2"/></svg>', ci = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><rect width="14" height="14" x="5" y="5" stroke="currentColor" stroke-width="2" rx="4"/><line x1="12" x2="12" y1="9" y2="12" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M12 15.02V15.01"/></svg>';
class Ot {
}
const di = "__", hi = "--";
function he(r) {
  return (e, t) => [[r, e].filter((i) => !!i).join(di), t].filter((i) => !!i).join(hi);
}
const $ = he("ce-popover-item"), _ = {
  container: $(),
  active: $(null, "active"),
  disabled: $(null, "disabled"),
  focused: $(null, "focused"),
  hidden: $(null, "hidden"),
  confirmationState: $(null, "confirmation"),
  noHover: $(null, "no-hover"),
  noFocus: $(null, "no-focus"),
  title: $("title"),
...
class Ne extends Ot {
   ...
   */
  make(e) {
    const t = c.make("div", _.container);
    return e.name && (t.dataset.itemName = e.name), this.nodes.icon = c.make("div", [_.icon, _.iconTool], {
      innerHTML: e.icon || ii
    }), t.appendChild(this.nodes.icon), t.appendChild(c.make("div", _.title, {
      innerHTML: e.title || ""
    })), e.secondaryLabel && t.appendChild(c.make("div", _.secondaryTitle, {
      textContent: e.secondaryLabel
    })), this.children.length > 0 && t.appendChild(c.make("div", [_.icon, _.iconChevronRight], {
      innerHTML: ei
...
class pt extends Ot {
  ...
  constructor() {
    super(), this.nodes = {
      root: c.make("div", De.container),
      line: c.make("div", De.line)
...
class ui extends ye {
  ...
  constructor({ items: e, placeholder: t }) {
    super(), this.listeners = new Ee(), this.items = e, this.wrapper = c.make("div", Fe.wrapper);
    const o = c.make("div", Fe.icon, {
      innerHTML: ai
    });
    this.input = c.make("input", Fe.input, {
      placeholder: t,
      /**
...
class Nt extends ye {
  ...
  constructor(e) {
    super(), this.params = e, this.listeners = new Ee(), this.messages = {
      ...
      ...this.messages,
      ...e.messages
    }), this.nodes = {}, this.nodes.popoverContainer = c.make("div", [O.popoverContainer]), this.nodes.nothingFoundMessage = c.make("div", [O.nothingFoundMessage], {
      textContent: this.messages.nothingFound
    }), this.nodes.popoverContainer.appendChild(this.nodes.nothingFoundMessage), this.nodes.items = c.make("div", [O.items]), this.items.forEach((t) => {
      const o = t.getElement();
      o !== null && this.nodes.items.appendChild(o);
    }), this.nodes.popoverContainer.appendChild(this.nodes.items), this.listeners.on(this.nodes.popoverContainer, "click", (t) => this.handleClick(t)), this.nodes.popover = c.make("div", [
      O.popover,
      this.params.class
...
var pi = Object.defineProperty, fi = Object.getOwnPropertyDescriptor, gi = (r, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? fi(e, t) : e, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (i = (o ? n(e, t, i) : n(i)) || i);
  return o && i && pi(e, t, i), i;
};
const Rt = class Dt extends Nt {
  /**
...
const Ft = class me {
   ...
   */
  lock() {
    ct ? this.lockHard() : document.body.classList.add(me.CSS.scrollLocked);
  }
  /**
   * Unlocks body element scroll
   */
  unlock() {
    ct ? this.unlockHard() : document.body.classList.remove(me.CSS.scrollLocked);
  }
  /**
...
class bi {
  ...
  constructor({ text: e, onBackButtonClick: t }) {
    this.listeners = new Ee(), this.text = e, this.onBackButtonClick = t, this.nodes = {
      root: c.make("div", [ze.root]),
      backButton: c.make("button", [ze.backButton]),
      text: c.make("div", [ze.text])
...
class Ht extends Nt {
   ...
   */
  constructor(e) {
    super(e), this.scrollLocker = new mi(), this.history = new ki(), this.nodes.overlay = c.make("div", [O.overlay, O.overlayHidden]), this.nodes.popover.insertBefore(this.nodes.overlay, this.nodes.popover.firstChild), this.listeners.on(this.nodes.overlay, "click", () => {
      this.hide();
   ...
   */
  show() {
    this.nodes.overlay.classList.remove(O.overlayHidden), super.show(), this.scrollLocker.lock();
  }
  /**
   * Closes popover
   */
  hide() {
    super.hide(), this.nodes.overlay.classList.add(O.overlayHidden), this.scrollLocker.unlock(), this.history.reset();
  }
  /**
   * Clears memory
   */
...
class vi extends y {
   ...
   */
  make() {
    this.nodes.wrapper = c.make("div", [this.CSS.settings]), this.eventsDispatcher.on(ke, this.close);
  }
  /**
   * Destroys module
   */
  ...
  open(e = this.Editor.BlockManager.currentBlock) {
    ...
    this.popover = new i({
      ...
      messages: {
        nothingFound: Y.ui(V.ui.popover, "Nothing found"),
        search: Y.ui(V.ui.popover, "Filter")
      }
    }), this.popover.on(ie.Close, this.onPopoverClose), (s = this.nodes.wrapper) == null || s.append(this.popover.getElement()), this.popover.show();
  }
  /**
...
class W extends y {
  ...
  make() {
    ...
    ]), this.nodes.tools = c.make("div", W.CSS.conversionToolbarTools);
    const e = c.make("div", W.CSS.conversionToolbarLabel, {
      textContent: Y.ui(V.ui.inlineToolbar.converter, "Convert to")
    });
  ...
  open() {
    this.filterTools(), this.opened = !0, this.nodes.wrapper.classList.add(W.CSS.conversionToolbarShowed), window.requestAnimationFrame(() => {
      this.flipper.activate(this.tools.map((e) => e.button).filter((e) => !e.classList.contains(W.CSS.conversionToolHidden))), this.flipper.focusFirst(), M(this.togglingCallback) && this.togglingCallback(!0);
    });
  }
  /**
   ...
   */
  close() {
    this.opened = !1, this.flipper.deactivate(), this.nodes.wrapper.classList.remove(W.CSS.conversionToolbarShowed), M(this.togglingCallback) && this.togglingCallback(!1);
  }
  /**
  ...
  addTool(e, t) {
    var n;
    const o = c.make("div", [W.CSS.conversionTool]), i = c.make("div", [W.CSS.conversionToolIcon]);
    o.dataset.tool = e, i.innerHTML = t.icon, c.append(o, i), c.append(o, c.text(Y.t(V.toolNames, t.title || le(e))));
    const s = (n = this.Editor.Tools.blockTools.get(e)) == null ? void 0 : n.shortcut;
    if (s) {
      const a = c.make("span", W.CSS.conversionToolSecondaryLabel, {
        innerText: Le(s)
      });
      c.append(o, a);
    }
  ...
  async filterTools() {
    ...
    this.tools.forEach((i) => {
      ...
      i.button.hidden = s, i.button.classList.toggle(W.CSS.conversionToolHidden, s);
    });
  }
  /**
  ...
  (function(t, o) {
    ...
    return function(t) {
      ...
      var a = function() {
        ...
        } }]), n(l, [{ key: "parseShortcutName", value: function(d) {
          d = d.split("+");
          for (var u = 0; u < d.length; u++) {
            d[u] = d[u].toUpperCase();
            var h = !1;
...
const ce = new yi();
var Ei = Object.defineProperty, Bi = Object.getOwnPropertyDescriptor, Ut = (r, e, t, o) => {
...
const Ge = class jt extends ye {
  ...
  constructor({ api: e, tools: t, i18nLabels: o }) {
    super(), this.opened = !1, this.listeners = new Ee(), this.popover = null, this.handleMobileLayoutToggle = () => {
      ...
      toolbox: c.make("div", jt.CSS.toolbox)
  ...
  get toolboxItemsToBeDisplayed() {
    const e = (t, o) => ({
      icon: t.icon,
      title: Y.t(V.toolNames, t.title || le(o.name)),
      name: o.name,
      onActivate: () => {
...
Ut([
  de
], Ge.prototype, "toolsToBeDisplayed", 1);
Ut([
  de
], Ge.prototype, "toolboxItemsToBeDisplayed", 1);
let Ti = Ge;
const $t = "block hovered";
...
class Si extends y {
   ...
   */
  async make() {
    this.nodes.wrapper = c.make("div", this.CSS.toolbar), ["content", "actions"].forEach((s) => {
      this.nodes[s] = c.make("div", this.CSS[s]);
      ...
      Ke(!0), this.plusButtonClicked();
    }, !1);
    const e = c.make("div");
    e.appendChild(document.createTextNode(Y.ui(V.ui.toolbar.toolbox, "Add"))), e.appendChild(c.make("div", this.CSS.plusButtonShortcut, {
      textContent: "/"
    ...
    const t = c.make("div"), o = c.text(Y.ui(V.ui.blockTunes.toggler, "Click to tune")), i = await Ci("Slash", "/");
  ...
  makeToolbox() {
    return this.toolboxInstance = new Ti({
      ...
      i18nLabels: {
        filter: Y.ui(V.ui.popover, "Filter"),
        nothingFound: Y.ui(V.ui.popover, "Nothing found")
      }
  ...
  enableModuleBindings() {
    this.readOnlyMutableListeners.on(this.nodes.settingsToggler, "mousedown", (e) => {
      var t;
      e.stopPropagation(), this.settingsTogglerClicked(), (t = this.toolboxInstance) != null && t.opened && this.toolboxInstance.close(), Ke(!0);
    }, !0), ae() || this.eventsDispatcher.on($t, (e) => {
      var t;
...
var Ae = /* @__PURE__ */ ((r) => (r[r.Block = 0] = "Block", r[r.Inline = 1] = "Inline", r[r.Tune = 2] = "Tune", r))(Ae || {}), Te = /* @__PURE__ */ ((r) => (r.Shortcut = "shortcut", r.Toolbox = "toolbox", r.EnabledInlineTools = "inlineToolbar", r.EnabledBlockTunes = "tunes", r.Config = "config", r))(Te || {}), Wt = /* @__PURE__ */ ((r) => (r.Shortcut = "shortcut", r.SanitizeConfig = "sanitize", r))(Wt || {}), re = /* @__PURE__ */ ((r) => (r.IsEnabledLineBreaks = "enableLineBreaks", r.Toolbox = "toolbox", r.ConversionConfig = "conversionConfig", r.IsReadOnlySupported = "isReadOnlySupported", r.PasteConfig = "pasteConfig", r))(re || {}), Je = /* @__PURE__ */ ((r) => (r.IsInline = "isInline", r.Title = "title", r))(Je || {}), Yt = /* @__PURE__ */ ((r) => (r.IsTune = "isTune", r))(Yt || {});
class Qe {
  /**
   * @class
...
class Ii extends y {
  ...
  addConversionToggler() {
    ...
    }), ae() === !1 && ve(this.nodes.conversionToggler, Y.ui(V.ui.inlineToolbar.converter, "Convert to"), {
      placement: "top",
      hidingDelay: 100
    });
  }
  ...
  addTool(e) {
    ...
    const s = c.make("div"), n = Y.t(
      V.toolNames,
      e.title || le(e.name)
    );
    s.appendChild(c.text(n)), i && s.appendChild(c.make("div", this.CSS.inlineToolbarShortcut, {
      textContent: Le(i)
    })), ae() === !1 && ve(o, s, {
      placement: "top",
      hidingDelay: 100
...
const ft = "block-removed", gt = "block-added", Li = "block-moved", mt = "block-changed";
class Ai {
  constructor() {
...
class _i extends y {
  ...
  insert({
    ...
    return n && this.blockDidMutated(ft, this.getBlockByIndex(l), {
      index: l
    }), this._blocks.insert(l, d, n), this.blockDidMutated(gt, d, {
      index: l
  ...
  move(e, t = this.currentBlockIndex) {
    ...
    this._blocks.move(e, t), this.currentBlockIndex = e, this.blockDidMutated(Li, this.currentBlock, {
      fromIndex: t,
      toIndex: e
    });
  }
...
class Oi extends y {
  ...
  copySelectedBlocks(e) {
    ...
    this.selectedBlocks.forEach((s) => {
      const n = q(s.holder.innerHTML, this.sanitizerConfig), a = c.make("p");
...
class Ie extends y {
  ...
  get isAtStart() {
    ...
    if (!(e != null && e.focusable))
      return !0;
    const t = m.get(), o = c.getDeepestNode(e.currentInput);
    let i = t.focusNode;
    ...
    s === -1 && (s = 0);
    let n = t.focusOffset;
    return i.nodeType !== Node.TEXT_NODE && i.childNodes.length && (i.childNodes[n] ? (i = i.childNodes[n], n = 0) : (i = i.childNodes[n - 1], n = i.textContent.length)), (c.isLineBreakTag(o) || c.isEmpty(o)) && this.getHigherLevelSiblings(i, "left").every((d) => {
  ...
  get isAtEnd() {
    ...
    if (!t.focusNode)
      return !1;
    let s = t.focusOffset;
    if (o.nodeType !== Node.TEXT_NODE && o.childNodes.length && (o.childNodes[s - 1] ? (o = o.childNodes[s - 1], s = o.textContent.length) : (o = o.childNodes[0], s = 0)), c.isLineBreakTag(i) || c.isEmpty(i)) {
      const a = this.getHigherLevelSiblings(o, "right");
      if (a.every((d, u) => u === a.length - 1 && c.isLineBreakTag(d) || c.isEmpty(d) && !c.isLineBreakTag(d)) && s === o.textContent.length)
        return !0;
    }
  ...
  setToBlock(e, t = this.positions.DEFAULT, o = 0) {
    ...
    if (s.clearSelection(), !e.focusable) {
      (d = window.getSelection()) == null || d.removeAllRanges(), s.selectBlock(e), i.currentBlock = e;
      return;
    }
    let n;
    switch (t) {
    ...
    if (!n)
      return;
    const a = c.getDeepestNode(n, t === this.positions.END), l = c.getContentLength(a);
    switch (!0) {
...
class Di extends y {
   ...
   */
  redactorChanged(e) {
    this.eventsDispatcher.emit(Ye, {
      mutations: e
    });
  }
}
const Kt = class Xt extends y {
  constructor() {
  ...
  async processDataTransfer(e, t = !1) {
    ...
    const d = Object.keys(this.toolsTags).reduce((f, b) => (f[b.toLowerCase()] = this.toolsTags[b].sanitizationConfig ?? {}, f), {}), u = Object.assign({}, d, o.getAllInlineToolsSanitizeConfig(), { br: {} }), h = q(l, u);
    !h.trim() || h.trim() === a || !c.isHTMLString(h) ? await this.processText(a) : await this.processText(h, !0);
  }
  /**
  ...
  async processText(e, t = !1) {
    ...
    s.map(
      async (l, d) => this.insertBlock(l, d === 0 && a)
  ...
  getFilesConfig(e) {
    ...
    !o && !i || (o && !Array.isArray(o) && (C(`«extensions» property of the onDrop config for «${e.name}» Tool should be an array`), o = []), i && !Array.isArray(i) && (C(`«mimeTypes» property of the onDrop config for «${e.name}» Tool should be an array`), i = []), i && (i = i.filter((s) => co(s) ? !0 : (C(`MIME type value «${s}» for the «${e.name}» Tool is not a valid MIME type`, "warn"), !1))), this.toolsFiles[e.name] = {
      extensions: o || [],
      mimeTypes: i || []
    });
  }
   ...
   */
  async processFile(e) {
    const t = lo(e), o = Object.entries(this.toolsFiles).find(([n, { mimeTypes: a, extensions: l }]) => {
      const [d, u] = e.type.split("/"), h = l.find((b) => b.toLowerCase() === t.toLowerCase()), f = a.find((b) => {
        const [p, k] = b.split("/");
        return p === d && (k === u || k === "*");
      });
      return !!h || !!f;
   ...
   */
  processHTML(e) {
    const { Tools: t } = this.Editor, o = c.make("DIV");
    return o.innerHTML = e, this.getNodes(o).map((s) => {
      let n, a = t.defaultTool, l = !1;
      switch (s.nodeType) {
        case Node.DOCUMENT_FRAGMENT_NODE:
          n = c.make("div"), n.appendChild(s);
          break;
        case Node.ELEMENT_NODE:
          n = s, l = !0, this.toolsTags[n.tagName] && (a = this.toolsTags[n.tagName].tool);
          break;
      }
      const { tags: d } = a.pasteConfig || { tags: [] }, u = d.reduce((b, p) => (this.collectTagNames(p).forEach((L) => {
      ...
      const n = c.isEmpty(s.content), a = c.isSingleTag(s.content);
      return !n || a;
    });
  }
  /**
  ...
  async processSingleBlock(e) {
    ...
    if (!i || e.tool !== i.name || !c.containsOnlyInlineElements(e.content.innerHTML)) {
  ...
  processElementNode(e, t, o) {
    const i = Object.keys(this.toolsTags), s = e, { tool: n } = this.toolsTags[s.tagName] || {}, a = this.tagsByTool[n == null ? void 0 : n.name] || [], l = i.includes(s.tagName), d = c.blockElements.includes(s.tagName.toLowerCase()), u = Array.from(s.children).some(
      ({ tagName: f }) => i.includes(f) && !a.includes(f)
    ), h = Array.from(s.children).some(
      ({ tagName: f }) => c.blockElements.includes(f.toLowerCase())
    );
    if (!d && !l && !u)
  ...
  getNodes(e) {
    ...
    const i = (s, n) => {
      ...
      switch (a && c.isFragment(a) && (l = s.pop()), n.nodeType) {
        case Node.ELEMENT_NODE:
...
class be extends y {
   ...
   */
  genHTML() {
    const { UI: e } = this.Editor, t = e.nodes.holder.querySelector("." + e.CSS.editorWrapper), o = c.make("div", be.CSS.overlay, {}), i = c.make("div", be.CSS.overlayContainer, {}), s = c.make("div", be.CSS.rect, {});
  ...
  trySelectNextBlock(e) {
    ...
    let l = n;
    o > 1 && (l = a ? i : s);
    const d = e > this.stackOfSelected[o - 1] && l === i, u = e < this.stackOfSelected[o - 1] && l === s, f = !(d || u || l === n);
  ...
  async render(e) {
    return new Promise((t) => {
      ...
      if (e.length === 0)
        ...
        const s = e.map(({ type: n, data: a, tunes: l, id: d }) => {
          o.available.has(n) === !1 && (X(`Tool «${n}» is not found. Check 'tools' property at the Editor.js config.`, "warn"), a = this.composeStubDataForTool(n, a, d), n = o.stubTool);
          let u;
          try {
            u = i.composeBlock({
              id: d,
            ...
            C(`Block «${n}» skipped because of plugins error`, "error", {
              data: a,
              error: h
            }), a = this.composeStubDataForTool(n, a, d), n = o.stubTool, u = i.composeBlock({
              id: d,
              tool: n,
              data: a,
              tunes: l
...
class zi extends y {
  ...
  async save() {
    ...
    try {
      ...
      const s = await Promise.all(i), n = await Ve(s, (a) => t.blockTools.get(a).sanitizeConfig);
...
class et {
  ...
  constructor({ data: e, config: t, api: o, readOnly: i }) {
    ...
    }, this.readOnly || (this.onKeyUp = this.onKeyUp.bind(this)), this._placeholder = t.placeholder ? t.placeholder : et.DEFAULT_PLACEHOLDER, this._data = e ?? {}, this._element = null, this._preserveBlank = t.preserveBlank !== void 0 ? t.preserveBlank : !1;
  }
  /**
...
class ot {
   ...
   */
  render() {
    return this.nodes.button = document.createElement("button"), this.nodes.button.type = "button", this.nodes.button.classList.add(this.CSS.button, this.CSS.buttonModifier), this.nodes.button.innerHTML = si, this.nodes.button;
  }
  /**
...
class it {
  ...
  checkState() {
    ...
    if (e) {
      this.nodes.button.innerHTML = li, this.nodes.button.classList.add(this.CSS.buttonUnlink), this.nodes.button.classList.add(this.CSS.buttonActive), this.openActions();
...
class Vt {
   ...
   */
  make() {
    const e = c.make("div", this.CSS.wrapper), t = ci, o = c.make("div", this.CSS.info), i = c.make("div", this.CSS.title, {
...
var Yi = Object.defineProperty, Ki = Object.getOwnPropertyDescriptor, qt = (r, e, t, o) => {
  for (var i = o > 1 ? void 0 : o ? Ki(e, t) : e, s = r.length - 1, n; s >= 0; s--)
    (n = r[s]) && (i = (o ? n(e, t, i) : n(i)) || i);
...
qt([
  de
], st.prototype, "sanitizeConfig", 1);
qt([
  de
], st.prototype, "baseSanitizeConfig", 1);
class Xi {
  /**
   * @class
...
Jt.isTune = !0;
var Vi = Object.defineProperty, qi = Object.getOwnPropertyDescriptor, Zi = (r, e, t, o) => {
...
class Qt extends y {
  ...
  async prepare() {
    ...
    this.factory = new Xi(e, this.config, this.Editor.API);
...
Zi([
  de
], Qt.prototype, "getAllInlineToolsSanitizeConfig", 1);
...
class Qi extends y {
  constructor() {
    super(...arguments), this.isMobile = !1, this.contentRectCache = void 0, this.resizeDebouncer = lt(() => {
      this.windowResize();
    }, 200);
  }
  /**
  ...
  watchBlockHoveredEvents() {
    ...
    this.readOnlyMutableListeners.on(this.nodes.redactor, "mousemove", je((t) => {
      ...
      this.Editor.BlockSelection.anyBlockSelected || o && e !== o && (e = o, this.eventsDispatcher.emit($t, {
  ...
  redactorClicked(e) {
    ...
    if (c.isAnchor(t) && o) {
      ...
      const i = t.getAttribute("href"), s = uo(i);
      fo(s);
      return;
    }
...
class ts {
  ...
  set configuration(e) {
    ...
    D(e) ? this.config = {
      ...
      holder: e
    }, We(!!this.config.holderId, "config.holderId", "config.holder"), this.config.holderId && !this.config.holder && (this.config.holder = this.config.holderId, this.config.holderId = null), this.config.holder == null && (this.config.holder = "editorjs"), this.config.logLevel || (this.config.logLevel = bt.VERBOSE), no(this.config.logLevel), We(!!this.config.initialBlock, "config.initialBlock", "config.defaultBlock"), this.config.defaultBlock = this.config.defaultBlock || this.config.initialBlock || "paragraph", this.config.minHeight = this.config.minHeight !== void 0 ? this.config.minHeight : 300;
    const t = {
    ...
    }), this.config.inlineToolbar = this.config.inlineToolbar !== void 0 ? this.config.inlineToolbar : !0, (K(this.config.data) || !this.config.data.blocks || this.config.data.blocks.length === 0) && (this.config.data = { blocks: [t] }), this.config.readOnly = this.config.readOnly || !1, (o = this.config.i18n) != null && o.messages && Y.setDictionary(this.config.i18n.messages), this.config.i18n.direction = ((i = this.config.i18n) == null ? void 0 : i.direction) || "ltr";
  }
  /**
